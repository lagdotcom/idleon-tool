...
const shirts = [
  ...
  i("Planktop", planktop),
  i("Iron Platebody", ironPlatebody, "EquipmentShirts12"),
  i("Hide Shirt", hideShirt),
  i("Tattered Cloth", tatteredCloth, "EquipmentShirts21"),
  i("Fur Shirt", furShirt, "EquipmentShirts10"),
  i("MCR Tshirt", mCRTshirt),
  i("Amarok Bodyplate", amarokBodyplate, "EquipmentShirts18"),
  i("Gold Platebody", goldPlatebody, "EquipmentShirts13"),
