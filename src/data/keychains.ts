...
export const keychains = [
  ...
  i("Piggy Chain", piggyChain, "EquipmentKeychain5"),
  i("Dumbphone Chain", dumbphoneChain, "EquipmentKeychain6"),
  i("Horn Chain", hornChain, "EquipmentKeychain7"),
  i("Rustic Key Chain", rusticKeyChain),
  i("Taco Chain", tacoChain, "EquipmentKeychain9"),
  ...
  i("Pincer Hand Chain", pincerHandChain, "EquipmentKeychain16"),
  ...
  i("BobGoldPickle Chain", bobGoldPickleChain, "EquipmentKeychain24"),
